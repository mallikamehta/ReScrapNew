                                ...
                                <ul id="prodListingContainer">
                                    <li class="listpager">
                                        <div class="scrap_w">
                                            ...
                                            <div class="scrap_ttl" title="Beer Bottles">Glass</div>
                                            <p class="scrap_price"><b>Price: </b>&#8377;&nbsp;2.00/kg</p>

                                            <p class="scrap_min_order"> <b>Min.Order Amount:</b> &#8377;&nbsp;2.00</p>

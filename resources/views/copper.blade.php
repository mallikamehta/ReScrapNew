                            ...
                            <div id="my_data">
                                <ul id="prodListingContainer">
                                    <li class="listpager">
                                        <div class="scrap_w">
                                            <div class="scrap_img">
                                                <figure><img src="img/product/copper.jpg" alt=""></figure>
                                            </div>
                                            <div class="scrap_ttl" title="Beer Bottles">Copper</div>
                                            <p class="scrap_price"><b>Price: </b>&#8377;&nbsp;520.00/kg</p>

                                            <p class="scrap_min_order"> <b>Min.Order Amount:</b> &#8377;&nbsp;500.00</p>

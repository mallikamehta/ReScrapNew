                            ...
                            <div id="my_data">
                                <ul id="prodListingContainer">
                                    <li class="listpager">
                                        <div class="scrap_w">
                                            <div class="scrap_img">
                                                <figure><img src="img/product/Aluminum.jpg" alt=""></figure>
                                            </div>
                                            <div class="scrap_ttl" title="Beer Bottles">Aluminium</div>
                                            <p class="scrap_price"><b>Price: </b>&#8377;&nbsp;130.00/kg</p>
                                    ...
                                    <li class="listpager">
                                        <div class="scrap_w">
                                            <div class="scrap_img">
                                                <figure><img src="img/product/invetor.png" alt=""></figure>
                                            </div>
                                            <div class="scrap_ttl" title="Beer Bottles">Inverter</div>
                                            <p class="scrap_price"><b>Price: </b>&#8377;&nbsp;55.00/kg</p>
                                    ...
                                    <li class="listpager">
                                        <div class="scrap_w">
                                            <div class="scrap_img">
                                                <figure><img src="img/product/motor.png" alt=""></figure>
                                            </div>
                                            <div class="scrap_ttl" title="Beer Bottles">Motor</div>
                                            <p class="scrap_price"><b>Price: </b>&#8377;&nbsp;45.00/kg</p>
                                    ...
                                    <li class="listpager">
                                        <div class="scrap_w">
                                            ...
                                            <div class="scrap_ttl" title="Beer Bottles">Brass</div>
                                            <p class="scrap_price"><b>Price: </b>&#8377;&nbsp;350.00/kg</p>

                                            <p class="scrap_min_order"> <b>Min.Order Amount:</b> &#8377;&nbsp;325.00</p>
                                    ...
                                    <li class="listpager">
                                        <div class="scrap_w">
                                            ...
                                            <div class="scrap_ttl" title="Beer Bottles">Steel Scrap</div>
                                            <p class="scrap_price"><b>Price: </b>&#8377;&nbsp;40.00/kg</p>

                                            <p class="scrap_min_order"> <b>Min.Order Amount:</b> &#8377;&nbsp;35.00</p>

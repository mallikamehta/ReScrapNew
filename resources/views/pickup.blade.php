...
<body>
    ...
    @endif
    <form method="post" action="{{ url('save-pickup') }}" enctype="multipart/form-data">
        @csrf
            ...
            <div id="wizard">
                ...
                <section>
                    ...
                    <p class="success">Pickup request for scrap submitted successfully. Our team will arrange for the
                        pickup soon.

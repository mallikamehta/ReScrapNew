    ...
    <div class="container my-5 py-5 px-lg-5">
        <div class="row g-5 pt-5">
            <div class="col-12 text-center text-lg-start">
                <h1 class="display-4 text-white animated slideInLeft">Plastic Scrap Price List</h1>
                    ...
                    <div id="my_data">
                        <ul id="prodListingContainer">
                            <li class="listpager">
                                <div class="scrap_w">
                                    <div class="scrap_img">
                                        <figure><img src="img/product/plastic-waste.jpg" alt=""></figure>
                                    </div>
                                    <div class="scrap_ttl" title="Beer Bottles">Plastic</div>
                                    <p class="scrap_price"><b>Price: </b>&#8377;&nbsp;12.00/kg</p>
                                    <p class="scrap_min_order"> <b>Min.Order Amount:</b> &#8377;&nbsp;250.00
                                    </p>
